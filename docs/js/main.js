$(function () {
    ...
    // --------------------smooth-scrol----------------
    $(".header__links-faq, .footer__col-logo, .header__links-work, .footer__col-link, .menu__mobile__links-faq, .menu__mobile__links-work, .footer__mobile__links-work, .footer__mobile__links-faq, .footer__mobile-logo").on("click", function (e) {
        e.preventDefault()
