$(function () {
    ...
    // --------------------smooth-scrol----------------
    $(".header__links-faq, .mob__button-1, .footer__col-logo, .header__links-work, .footer__col-link, .menu__mobile__links-faq, .menu__mobile__links-work, .footer__mobile-logo").on("click", function (e) {
        e.preventDefault()
    ...
    $('.modal__search-close, .modal__coop-close, .modal__choose-close, .mob__button-2,').on("click", function () {
        $.fancybox.close();
    });
